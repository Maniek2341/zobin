...
from modules.users.views import LoginView, ResetView, ForgotView, LogoutView, ProfileView, CreateView, ListUserView, UserRemoveView
from modules.users.views.user_edit_view import UserEditView
